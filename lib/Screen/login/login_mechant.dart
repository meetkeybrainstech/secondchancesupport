                              ...
                              if(form_key.currentState!.validate()){
                                ...
                                try {
                                  ...
                                  if(user!.displayName == "Merchant"){
                                    final DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('merchants').doc(user.uid).get();
                                    ...
                                    print(token);
                                    FirebaseFirestore.instance.collection("merchants").doc(FirebaseAuth.instance.currentUser!.uid).update({
                                      "token":token
                                    ...
                                    showalert("Email is not register in Merchants", AlertType.error, context);
                                  }
