...
import 'package:homeless/Screen/Donor/Myjobs.dart';
import 'package:homeless/Screen/Donor/mydonations.dart';
...
class _AppDrawerState extends State<AppDrawer> {
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>MyDonation()));
  ...
  Stream<UserInfo?> _getUserInfoStream() {
    ...
    if (user != null) {
      return _firestore
          .collection('donor') // Change this to your users collection
          .doc(user)
          .snapshots()
          .map((snapshot) {
        if (snapshot.exists) {
